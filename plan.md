...
This standalone project automates sending daily Snapchat streaks cycling through a catalog of world monument photos using an Android emulator and ADB (Android Debug Bridge).

## Core Architecture
1. **Photo Catalog:** A local folder `monuments/` containing images of world monuments.
...
4. **Snapchat UI Automation:** ADB simulates tap and search inputs to:
   ...
   - Select the newly added monument photo.
   - Tap "Send To".
...
- `monuments/` - Directory holding monument images to cycle through.
